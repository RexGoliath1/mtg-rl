...
| File | Purpose | Params |
|------|---------|--------|
| `src/mechanics/vocabulary.py` | Mechanics primitives (VOCAB_SIZE=1349) | - |
...
1. **Mechanics-Based Card Encoding**: Cards are multi-hot vectors over ~1338 primitives, not opaque embeddings
...
**Key files:**
- `src/mechanics/vocabulary.py` - ~1349 mechanics primitives (VOCAB_SIZE)
...
- [x] Mechanics vocabulary defined (VOCAB_SIZE=1349) - src/mechanics/vocabulary.py
