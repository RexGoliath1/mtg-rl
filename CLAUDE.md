...
| File | Purpose | Params |
|------|---------|--------|
| `src/mechanics/vocabulary.py` | Mechanics primitives (VOCAB_SIZE=1352) | - |
...
**Key files:**
- `src/mechanics/vocabulary.py` - ~1352 mechanics primitives (VOCAB_SIZE)
...
- [x] Mechanics vocabulary defined (VOCAB_SIZE=1352) - src/mechanics/vocabulary.py
