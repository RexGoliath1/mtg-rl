...
| File | Purpose | Params |
|------|---------|--------|
| `src/mechanics/vocabulary.py` | Mechanics primitives (VOCAB_SIZE=1382) | - |
...
**Key files:**
- `src/mechanics/vocabulary.py` - ~1382 mechanics primitives (VOCAB_SIZE)
...
- [x] Mechanics vocabulary defined (VOCAB_SIZE=1382) - src/mechanics/vocabulary.py
