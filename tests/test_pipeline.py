...
Requires sentence-transformers for HybridCardEncoder text embeddings.
Skipped when sentence-transformers is not installed.
"""
import pytest

torch = pytest.importorskip("torch")
pytest.importorskip("sentence_transformers", reason="DraftModel requires sentence-transformers")
